...
resource "null_resource" "name" {
  ...
  connection {
    type        = "ssh"
    user        = "ec2-user"
    private_key = file("/home/ezekiel/Downloads/mcd-key-pair.pem")
  ...
  provisioner "file" {
    source      = "/home/ezekiel/Downloads/my_password.txt"
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo sh /home/ec2-user/build-docker-image.sh"
